...
Config.instname = "Aix-Marseille Université (AMU)"
Config.profilename = "EDUROAM_WPA2_PEAP"
Config.url = "your local eduroam® support page"
Config.email = "dirnum-eduroam-support@univ-amu.fr"
Config.title = "eduroam CAT"
Config.server_match = "eduroam.univ-amu.fr"
...
Config.del_ssids = []
Config.servers = ['DNS:eduroam.univ-amu.fr']
